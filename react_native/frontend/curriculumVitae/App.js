  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.containerInfo}>
          ...
          <Text style={styles.textInfo}><Text style={styles.textSubTitulo}>Data de Nascimento:</Text> 26/09/1999</Text>
      ...
      <View style={styles.containerFormacao}>
          ...
          <Text style={styles.textInfo}>  • Cursando no Senac Bauru: uso de React Native para criação e estilização de aplicações mobile</Text>
